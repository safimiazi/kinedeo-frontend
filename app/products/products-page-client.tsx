...
/**
 * ProductsPageClient — handles search, sort, filter, infinite scroll.
 * Receives SSR-prefetched initial data from ProductsPage (page.tsx).
 */
...
export default function ProductsPageClient({ initialProducts, initialTotal, categories }: Props) {
  ...
  // Use SSR data until React Query hydrates
  const rqProducts = data?.pages.flatMap((p) => p.products) ?? [];
  const isFiltered = !!categoryId || !!debouncedSearch || sortIdx !== 0;
  const products = isFiltered || rqProducts.length > 0 ? rqProducts : initialProducts;
  ...
  return (
    <div className="min-h-screen bg-[#fff0f5] font-nunito">
      ...
      {/* Hero Banner */}
      <div className="bg-linear-to-r from-[#e91e8c] via-[#c2185b] to-[#ad1457] text-white py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-6">
              ...
              <div className="space-y-1">
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded-lg text-sm font-semibold transition-colors ${
                    !categoryId ? 'bg-[#e91e8c] text-white' : 'text-[#6d1b3b] hover:bg-pink-50'
                  }`}
                >
                  All Products
                </button>
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Loading skeleton — only shows on filter/sort changes */}
            ...
            {isError && (
              <div className="text-center py-20">
                <p className="text-[#ad1457] font-semibold">
            ...
            {!isLoading && !isError && products.length === 0 && (
              <div className="text-center py-20">
                ...
                <h3 className="font-playfair text-xl font-bold text-[#2d1a24] mb-2">
                  No products found
                </h3>
