...
const menuItems = [
  ...
  { label: "Flash Sales", href: "/dashboard/flash-sales", icon: "⚡" },
    ...
    <div className="flex h-screen bg-[#fdf2f8] font-nunito overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2 px-6 h-16 border-b border-pink-100">
          ...
          <span className="font-playfair text-lg font-extrabold text-[#e91e8c]">Petal</span>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-pink-100">
          ...
          <button
            ...
            className="w-full mt-2 px-4 py-2 text-xs font-medium text-red-500 hover:bg-red-50 rounded-lg transition-colors text-left"
          >
            🚪 Logout
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-pink-100 flex items-center justify-between px-4 lg:px-8 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/"
              className="text-xs font-medium text-[#ad1457] hover:text-[#e91e8c] transition-colors"
            >
              View Store →
            </Link>
          </div>
